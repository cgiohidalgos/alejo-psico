...
**Running title:** CliniA: simulación de pacientes con IA *(38 caracteres; máx. 40)*

> **Título (107 caracteres; cumple el rango 70–110 de la revista).** Se ajustó a partir del título propuesto —"CliniA: herramienta de inteligencia artificial para simular pacientes clínicos y fortalecer entrevistas psicológicas" (116 car.)— eliminando "clínicos" para respetar el máximo, ya que el contexto clínico queda implícito.

> **Nota para el envío:** revista *Guillermo de Ockham* (USB Cali). Tipo: **artículo de investigación científica** (estructura AIM-RD&C). Objetivo de extensión: **6.000 palabras** de cuerpo y **mínimo 30 fuentes** (≈30 % latinoamericanas, 70 % internacionales). Normas **APA 7** (estrictas; toda cita referenciada y viceversa). Maquetación final en Word: Times New Roman 12, interlineado 1,5, tamaño carta, márgenes 2,5 cm sup./inf. y 3,0 cm izq./der. Reemplazar los marcadores `[ ]` con los datos definitivos de autoría/afiliación.
...
**Financiación.** Esta investigación no recibió subvenciones específicas de organismos de financiación de los sectores público, comercial o sin ánimo de lucro. *(Si hubo financiación, usar el formato: "Esta investigación fue apoyada por [institución] [código de proyecto]".)*
...
**Agradecimientos.** [Personas que colaboraron sin cumplir criterios de autoría: recolección de datos, revisión del texto, apoyo bibliográfico o estadístico, etc. Eliminar si no aplica.]
...
*(Términos alineados en lo posible con el Tesauro de la UNESCO. Verificar cada término en el tesauro y depurar a 10–12 antes del envío.)*
...
> *Nota de cobertura.* La revista recomienda que ≈30 % de las fuentes sean latinoamericanas y 70 % internacionales. La lista actual cumple holgadamente el mínimo internacional; **es indispensable añadir las fuentes latinoamericanas marcadas más abajo** (con datos reales verificados) para satisfacer ese criterio y el mínimo de 30 referencias del tipo "artículo de investigación".
...
**Fuentes latinoamericanas.** Ya integradas y verificadas: Charria Ortiz et al. (2011) y UNESCO IESALC (2023). Para alcanzar holgadamente el ≈30 % recomendado conviene añadir 5–7 fuentes regionales más (sustituir cada marcador por una referencia real verificada y citarla en el texto):

- [Pacientes/escenarios simulados o estandarizados en educación en salud en América Latina].
- [Práctica deliberada o supervisión clínica en programas iberoamericanos de psicología].
- [Alianza terapéutica en población latinoamericana].
- [Ética de la IA en educación en contextos latinoamericanos].
- [Tecnología educativa / simulación en psicología en Colombia].
- [Estudios sobre la expresión del malestar / motivo de consulta en contextos colombianos].
- [Competencias del entrevistador clínico en literatura en español].

> **Verificación antes del envío.** (1) Tres referencias sobre LLM ya fueron verificadas con su fuente primaria: Cabrera Lozoya et al. (2025), Hicke et al. (2025) y Wang et al. (2024). Las cinco restantes (Borg, Kus, Min, Sancheti, Webb) corresponden a fuentes reales localizadas por título/URL, pero sus **apellidos, iniciales, año y datos de volumen siguen provisionales y deben verificarse** abriendo cada fuente y ajustarse las citas del texto. (2) Verificar los DOI/URL de todas las entradas con un gestor bibliográfico (Mendeley/Zotero). (3) Comprobar la **correspondencia exacta cita↔referencia** en ambos sentidos. La revista aplica APA 7 de forma estricta y devuelve los manuscritos mal referenciados.
