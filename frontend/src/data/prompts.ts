...
1. **estructura_preguntas**: ¿El estudiante mantuvo una estructura lógica en la entrevista? ¿Cubrió áreas relevantes (motivo de consulta, historia personal, familiar, social)?

2. **tecnica_entrevista**: ¿Utilizó técnicas apropiadas según su orientación teórica? ¿Hizo preguntas abiertas? ¿Mostró escucha activa?

3. **apertura_emocional**: ¿Logró generar un espacio seguro? ¿El paciente se abrió emocionalmente? ¿Manejó adecuadamente las resistencias?

4. **adecuacion_contexto**: ¿Consideró el contexto sociocultural del paciente? ¿Fue sensible a factores como género, nivel socioeconómico, desplazamiento, etc.?
